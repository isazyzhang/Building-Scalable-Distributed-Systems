...
public class Main {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    AtomicInteger nonSuccess = new AtomicInteger(0);
    ...
    Phase phase1 = new Phase("Phase One", numThreadsPhase1, rangeOfSkierIDs1, posReqs1, phase2Latch, 1, 90, success, nonSuccess, parameters);
    phase1.runPhase();
    ...
    Phase phase2 = new Phase("Phase Two", numThreadsPhase2, rangeOfSkierIDs2, posReqs2, phase3Latch, 91, 360, success, nonSuccess, parameters);
    phase2Latch.await();
    phase2.runPhase();
    ...
    Phase phase3 = new Phase("Phase Three", numThreadPhase3, rangeOfSkierIDs3, posReqs3, endLatch, 361, 420, success, nonSuccess, parameters);
    phase3Latch.await();
    phase3.runPhase();
    ...
    DataAnalyzer dataAnalyzer = new DataAnalyzer(success.get(), nonSuccess.get(), wallTime, parameters);
